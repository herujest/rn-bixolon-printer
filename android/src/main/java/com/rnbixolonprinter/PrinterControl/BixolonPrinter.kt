...
import com.rnbixolonprinter.consts.DeviceBus
import com.rnbixolonprinter.consts.DeviceCategory
import com.rnbixolonprinter.consts.DeviceName
...
class BixolonPrinter {
    ...
    suspend fun isDeviceAvailable(): Result<Boolean> {
        return try {
            Result.success(getTargetDevice() != null)
        } catch (e: Throwable) {
            Result.failure(e)
        }
    }
